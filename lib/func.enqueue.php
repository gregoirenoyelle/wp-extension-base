...
function gn_styles_front() {
	wp_register_style('styles-projet-front', plugins_url( 'css/styles-projet-front.css', dirname(__DIR__) ), array(), '1.0', 'all' );
...
function gn_scripts_front() {
	wp_register_script('scripts-projet-front',plugins_url( 'js/scripts-projet-front.js', dirname(__DIR__) ), array('jquery'),'1.0',true);
...
function gn_styles_back() {
	wp_register_style('styles-projet-back', plugins_url( 'css/styles-projet-back.css', dirname(__DIR__) ), array(), '1.0', 'all' );
...
function gn_scripts_back() {
	wp_register_script('scripts-projet-back',plugins_url( 'js/scripts-projet-back.js', dirname(__DIR__) ), array('jquery'),'1.0',true);
